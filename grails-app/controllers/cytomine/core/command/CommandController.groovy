...
class CommandController extends RestController {
    ...
    def undo = {
        ...
        if (lastCommands.isEmpty()) {
            def data = [success: true, message: messageSource.getMessage('cytomine.core.UndoCommand', [] as Object[], Locale.ENGLISH), callback: null, printMessage: true]
    ...
    def redo = {
        ...
        if (lastCommands.size() == 0) {
            def data = [success: true, message: messageSource.getMessage('cytomine.core.RedoCommand', [] as Object[], Locale.ENGLISH), callback: null, printMessage: true]
            responseSuccess([data])
            return
        }
