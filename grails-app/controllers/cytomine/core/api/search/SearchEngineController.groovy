package cytomine.core.api.search
...
//    @RestApiParam(name="maxSize", type="int", paramType = RestApiParamType.QUERY, description = "(Optional) Max size of the image (default: 256)")])
    public String redirectToImageURL() {
        //http://localhost:8080/searchEngine/buildGotoLink?className=cytomine.core.project.Project&id=57
        //http://localhost:8080/searchEngine/redirectToImageURL?className=cytomine.core.image.ImageInstance&id=14697772&max=64
