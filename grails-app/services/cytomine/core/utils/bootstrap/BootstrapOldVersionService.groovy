...
import cytomine.core.image.CompanionFile
import cytomine.core.image.ImageInstance
import cytomine.core.image.Mime
import cytomine.core.image.SliceInstance
import cytomine.core.image.multidim.ImageGroup
import cytomine.core.image.multidim.ImageGroupHDF5
import cytomine.core.image.multidim.ImageSequence
...
import cytomine.core.meta.Property
import cytomine.core.ontology.Track
import cytomine.core.processing.ImageFilter
import cytomine.core.project.Project
import cytomine.core.project.ProjectLastActivity
...
import cytomine.core.meta.Configuration
...
//        bootstrapUtilsService.updateSqlColumnConstraint("sec_user", "language", "SET NOT NULL")
        ...
        sql.executeUpdate("UPDATE attached_file SET filename = 'log.out' " +
                "WHERE domain_class_name = 'cytomine.core.processing.Job' AND filename LIKE '%.out';")
        ...
        sql.executeUpdate("delete from attached_file where domain_class_name = 'cytomine.core.image.AbstractImage' and filename like '/image/thumb%';")
        ...
        if (ImageGroup.count() > 0) {
            ...
            ImageGroup.findAll().each { group ->
                ...
                sql.executeUpdate("update attached_file set domain_class_name = 'cytomine.core.image.ImageInstance', " +
        ...
        if (Track.count() == 0) {
            ...
            sql.eachRow("select p.created, domain_ident, image_id, slice_id, key, value, " +
                ...
                sql.executeInsert("INSERT INTO annotation_track(id, created, version, annotation_class_name, " +
                        ...
                        "(nextval('hibernate_sequence'), '${it.created}', 0, 'cytomine.core.ontology.AlgoAnnotation', " +
...
//        sql.executeUpdate("update attached_file set domain_class_name = 'cytomine.core.utils.Description', " +
//                "domain_ident = description.id " +
//                "from description " +
//                "where attached_file.domain_ident = description.domain_ident " +
//                "and attached_file.domain_class_name = 'cytomine.core.project.Project';")
