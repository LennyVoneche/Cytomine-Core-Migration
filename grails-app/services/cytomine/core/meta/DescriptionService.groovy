...
class DescriptionService extends ModelService {
     ...
     */
    def add(def json) {
        if(json.domainClassName.equals("cytomine.core.project.Project")){
    ...
    def update(Description description, def jsonNewData) {
        ...
        if(description.domainClassName.equals("cytomine.core.project.Project")){
