...
//                "where aclObjectId.objectId = "+project.id+" and aclEntry.aclObjectIdentity = aclObjectId.id and aclEntry.sid = aclSid.id and aclSid.sid = UserJob.username and UserJob.class = 'cytomine.core.security.User'")
//        if(showUserJob) {
