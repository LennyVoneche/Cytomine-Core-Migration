...
import cytomine.core.image.server.RetrievalServer
...
class UserAnnotationService extends ModelService {
    ...
    def add(def json, def minPoint = null, def maxPoint = null) {
        ...
        properties.each {
            ...
            propertyService.addProperty("cytomine.core.ontology.UserAnnotation", addedAnnotation.id, key, value, currentUser, transaction)
        }
        ...
        def annotationTracks = tracksIds.collect { id ->
            def r = annotationTrackService.addAnnotationTrack("cytomine.core.ontology.UserAnnotation", addedAnnotation.id, id, addedAnnotation.slice.id, currentUser, transaction)
