...
import cytomine.core.sql.AlgoAnnotationListing
...
class AlgoAnnotationService extends ModelService {
    ...
    def add(def json) {
        ...
        def annotationTracks = tracksIds.collect { id ->
            def r = annotationTrackService.addAnnotationTrack("cytomine.core.ontology.AlgoAnnotation", addedAnnotation.id, id, addedAnnotation.slice.id, currentUser, transaction)
        ...
        properties.each {
            ...
            propertyService.addProperty("cytomine.core.ontology.AlgoAnnotation", addedAnnotation.id, key, value, currentUser, transaction)
        }
