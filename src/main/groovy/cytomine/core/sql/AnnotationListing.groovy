...
class UserAnnotationListing extends AnnotationListing {
    ...
    def getDomainClass() {
        return "cytomine.core.ontology.UserAnnotation"
    }
...
class AlgoAnnotationListing extends AnnotationListing {
    ...
    def getDomainClass() {
        return "cytomine.core.ontology.AlgoAnnotation"
    }
...
class ReviewedAnnotationListing extends AnnotationListing {
    ...
    def getDomainClass() {
        return "cytomine.core.ontology.ReviewedAnnotation"
    }
...
class RoiAnnotationListing extends AnnotationListing {
    ...
    def getDomainClass() {
        return "cytomine.core.processing.RoiAnnotation"
    }
