...
import cytomine.core.processing.RoiAnnotation
import cytomine.core.project.Project
import cytomine.core.utils.GisUtils
...
//    ])
    ...
    public static AnnotationDomain getAnnotationDomain(long id, String className = null) {
        def domain = null
        switch (className) {
            case "cytomine.core.ontology.UserAnnotation":
                domain = UserAnnotation
                break
            case "cytomine.core.ontology.AlgoAnnotation":
                domain = AlgoAnnotation
                break
            case "cytomine.core.ontology.ReviewedAnnotation":
                domain = ReviewedAnnotation
                break
            case "cytomine.core.processing.RoiAnnotation":
